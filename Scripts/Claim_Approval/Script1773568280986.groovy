...
WebUI.enhancedClick(findTestObject('Claim Booked/Page_Dashboard - SHRILIFE/Claim Booked option'))
 
WebUI.enhancedClick(findTestObject('Claim Intimation Shrilife/Page_Dashboard - SHRILIFE/a_Death Claim'))
 
WebUI.waitForElementClickable(findTestObject('Claim Booked/Page_Dashboard - SHRILIFE/Booked Claims button'), 20)
 
WebUI.enhancedClick(findTestObject('Claim Booked/Page_Dashboard - SHRILIFE/Booked Claims button'))

 WebUI.delay(5)
 
// If The Policy is assigned to Early Claims
WebUI.enhancedClick(findTestObject('Claim Booked/Page_Booked Claims/Early Claims'))
...
if (WebUI.waitForElementVisible(checkbox, 10, FailureHandling.OPTIONAL)) {
    ...
    WebUI.enhancedClick(checkbox //    WebUI.comment('Policy Details did not become visible within 10s.')
    ...
    WebUI.enhancedClick(findTestObject('Object Repository/Claim Booked/Page_Booked Claims/Dedupe Claims'))
	WebUI.delay(3)
    ...
    if (WebUI.waitForElementVisible(checkbox, 10, FailureHandling.OPTIONAL)) {
		...
		WebUI.delay(2)
        WebUI.enhancedClick(checkbox)
    } else {
        WebUI.clearText(findTestObject('Object Repository/Claim Booked/Page_Booked Claims/input_policy_no'))
 
        WebUI.enhancedClick(findTestObject('Object Repository/Claim Booked/Page_Booked Claims/Non Early Claims'))
		WebUI.delay(3)
        ...
        if (WebUI.waitForElementVisible(checkbox, 10, FailureHandling.OPTIONAL)) {
            ...
            WebUI.enhancedClick(findTestObject('Object Repository/Claim Booked/Page_Booked Claims/Lapsed Claims'))
			WebUI.delay(3)
...
WebUI.enhancedClick(findTestObject('Object Repository/Claim Booked/Page_Booked Claims/Manual allocation'))
 
WebUI.enhancedClick(findTestObject('Claim Booked/Page_Booked Claims/Select user'))
...
WebUI.enhancedClick(findTestObject('Claim Booked/Page_Booked Claims/button_Submit'))
...
WebUI.enhancedClick(findTestObject('Claim Booked/Page_Booked Claims/OK_button'))
...
WebUI.enhancedClick(findTestObject('Death Claim Assign/Page_Dashboard - SHRILIFE/Scrutiny Death Claim'))
 
WebUI.waitForElementVisible(findTestObject('Death Claim Assign/Page_Dashboard - SHRILIFE/assigned Claim button'), 10)
 
WebUI.enhancedClick(findTestObject('Death Claim Assign/Page_Dashboard - SHRILIFE/assigned Claim button'))
...
//WebUI.enhancedClick(findTestObject('Death Claim Assign/Page Claim Assessor/Early Claims'))
WebUI.enhancedClick(findTestObject('Object Repository/Death Claim Assign/Page Claim Assessor/Claim Type', [('ClaimType') : claimType]))
...
if (WebUI.verifyElementPresent(policydetails, 2, FailureHandling.OPTIONAL)) {
    WebUI.enhancedClick(policydetails)
}
 
 
WebUI.setText(findTestObject('Death Claim Assign/Page_Claims Assessor Review/Assessor Remark'), 'ok')
 
WebUI.enhancedClick(findTestObject('Death Claim Assign/Page_Claims Assessor Review/Admit Button'))
 
WebUI.enhancedClick(findTestObject('Death Claim Assign/Page_Claims Assessor Review/Manager Select'))
...
WebUI.enhancedClick(findTestObject('Death Claim Assign/Page_Claims Assessor Review/button_Submit'))
...
WebUI.enhancedClick(findTestObject('Death Claim Assign/Page_Claims Assessor Review/button_OK'))
...
WebUI.enhancedClick(findTestObject('Claim Intimate Decision/Page_Dashboard - SHRILIFE/Death Claim option'))
 
WebUI.waitForElementVisible(findTestObject('Claim Intimate Decision/Page_Dashboard - SHRILIFE/Decision Pending option'), 
    10)
 
WebUI.enhancedClick(findTestObject('Claim Intimate Decision/Page_Dashboard - SHRILIFE/Decision Pending option'))
...
WebUI.enhancedClick(findTestObject('Claim Intimate Decision/Page_Death Claims - SHRILIFE/Policy_details', [('policyNo') : data['PolicyNumber']]))
...
WebUI.enhancedClick(findTestObject('Claim Intimate Decision/Page_Death Claims - SHRILIFE/Admit_Button'))
...
WebUI.enhancedClick(findTestObject('Claim Intimate Decision/Page_Death Claims - SHRILIFE/button_OK'))
...
//else {
	...
	if(GlobalVariable.G_USER =='A05139') {
		...
		WebUI.waitForElementVisible(findTestObject('Object Repository/Claim Intimate Decision/Page_Dashboard - SHRILIFE/Decision Pending option_K02979'),
			10)
		WebUI.enhancedClick(findTestObject('Object Repository/Claim Intimate Decision/Page_Dashboard - SHRILIFE/Decision Pending option_K02979'))
		WebUI.waitForPageLoad(GlobalVariable.G_PageTimeout)
		WebUI.delay(3)
		//The Used XPath is parameterized
		WebUI.enhancedClick(findTestObject('Claim Intimate Decision/Page_Death Claims - SHRILIFE/Policy_details', [('policyNo') : data['PolicyNumber']]))
		...
		WebUI.enhancedClick(findTestObject('Claim Intimate Decision/Page_Death Claims - SHRILIFE/button_OK'))
			...
			WebUI.callTestCase(findTestCase('Test Cases/Claim_Portal/Login_Page'), [('UserID') : data['LvlTwo_ManagerID']])
			 ...
			 WebUI.enhancedClick(findTestObject('Claim Book Final Process/Page_Dashboard - SHRILIFE/Claim Booked option'))
			 WebUI.enhancedClick(findTestObject('Claim Book Final Process/Page_Dashboard - SHRILIFE/Death Claim'))
			 WebUI.waitForPageLoad(GlobalVariable.G_PageTimeout)
...
//			  }
			 ...
			 WebUI.enhancedClick(findTestObject('Claim Book Final Process/Page_Dashboard - SHRILIFE/Decision Pending Option'))
			 ...
			 WebUI.delay(2)
			 //WebUI.enhancedClick(findTestObject('Claim Book Final Process/Page_Booked Claims/Early Claims'))
			 ...
			 WebUI.enhancedClick(findTestObject('Claim Book Final Process/Page_Booked Claims/button_admit'))
			 ...
			 WebUI.enhancedClick(findTestObject('Claim Book Final Process/Page_Booked Claims/OK_button'))
